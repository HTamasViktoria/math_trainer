...
let thirdNmber = document.querySelector("#thirdNumber")
let secondOperation = document.querySelector("#secondOperation")
...
newButton.addEventListener("click", () => {
    ...
    thirdNumber.innerHTML = Math.floor(Math.random() * 10);
    equalsTo.innerHTML = "=";
...
checkButton.addEventListener("click", () => {
    if (parseInt(firstNumber.innerHTML) + parseInt(secondNumber.innerHTML) + parseInt(thirdNumber.innerHTML) == result.value) {
    ...
    else if (parseInt(firstNumber.innerHTML) + parseInt(secondNumber.innerHTML) + parseInt(thirdNumber.innerHTML) != result.value) {
        //correctOrNot.innerHTML = "Helytelen válasz!";
